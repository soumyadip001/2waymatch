        ...
        <div className="flex flex-wrap items-start justify-between pb-20">
          <div className="flex flex-col items-start w-auto text-lg md:w-1/6">
            <a href="#_" className="w-auto">
              {/* <img
                className="w-auto"
                src="/img/2waylogo.png" alt="Agni Matrimony"
              /> */}
              <AgniSvg />
            </a>
            <p className="mt-4 text-sm tracking-tight text-black">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit now se.
            </p>
          </div>
          <div
          ...
          >
            <div className="md:justify-self-end">
              <h3 className="font-semibold text-black uppercase">SOLUTIONS</h3>
            ...
            <div className="md:justify-self-end">
              <h3 className="font-semibold text-black uppercase">Support</h3>
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a href="#_" className="relative inline-block text-black group">
                    <span className="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-black opacity-0 group-hover:opacity-100 group-hover:translate-y-1"></span>
            ...
            <div className="md:justify-self-end">
              <h3 className="font-semibold text-black uppercase">Company</h3>
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a href="#_" className="relative inline-block text-black group">
                    <span className="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-black opacity-0 group-hover:opacity-100 group-hover:translate-y-1"></span>
            ...
            <div className="md:justify-self-end">
              <h3 className="font-semibold text-black uppercase">Legal</h3>
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a href="#_" className="relative inline-block text-black group">
                    <span className="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-black opacity-0 group-hover:opacity-100 group-hover:translate-y-1"></span>
