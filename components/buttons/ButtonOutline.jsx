function ButtonOutline({ children, onClick, primary = false, white = false, type = 'button' }) {
  ...
  const tailWindClasses = 'group inline-flex items-center justify-center rounded-md py-2 px-4 text-sm font-semibold border-2 bg-slate-900 border-slate-900 disabled:cursor-not-allowed'
